...
>
> - **clk -> clk**.- Este elemento contiene la señal de reloj, la cual será de 50MHz y que esta incluida dentro del diseño.
>   
...
>
> - **in_out[6] -> reset**.- Este pin de entrada produce el reset del módulo transmisor, el cual debe ser activado para inicializar dicho múdulo, se recomienda conectar un _push button_ configurado en pull down.
>
